...
cosinnus_group_patterns = patterns('cosinnus_poll.views',
    ...
    url(r'^feed/$', 'poll_ical_feed', name='feed'),                  
    ...
    url(r'^list/past/$', 'past_polls_list_view', name='list_past'),
    url(r'^add/$', 'entry_add_view',  {'form_view': 'add'},  name='poll-add'),
    url(r'^(?P<slug>[^/]+)/$', 'entry_detail_view', {'form_view': 'edit'},  name='poll-detail'),
    url(r'^(?P<slug>[^/]+)/edit/$', 'entry_edit_view', {'form_view': 'edit'}, name='poll-edit'),
    url(r'^(?P<slug>[^/]+)/delete/$', 'entry_delete_view', {'form_view': 'delete'}, name='poll-delete'),
